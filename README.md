...
> Les **saves multijoueur / serveur dédié** (volumineuses, plusieurs joueurs) sont prises en charge : sélectionne ton personnage dans la liste après l'import. Les structures récentes du format 1.0 que la bibliothèque de lecture ne gère pas sont ignorées sans bloquer l'import.
